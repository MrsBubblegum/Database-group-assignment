...
![Bookstore Database Entity Relationship Diagram](https://i.imgur.com/your-image-url.png)

*Note: The above ERD shows all tables and their relationships in the bookstore database system.*
